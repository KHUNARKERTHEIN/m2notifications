...
/**
 * SalesOrderSaveCommitObserver Observer.
 */
class SalesOrderSaveCommitObserver implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        try {
            if ($order->getState() == 'holded' || $order->getState() == 'canceled') {
                $ks_data = [];
                $ks_data['order_id']       = $lastOrderId;
